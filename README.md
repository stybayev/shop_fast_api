...
- [Приложение на удаленном сервере AWS](https://test-yoko.ddns.net/docs)
### Описание проекта:
[API](https://test-yoko.ddns.net/docs) для мобильного приложения, в котором полевой сотрудник заказчика будет выполнять визиты в магазины.
